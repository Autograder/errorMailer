...
/**
 * Checks a String against regexes defined in application.conf
 * thanks to ripper234 and his co-workers
 */
public class ExclusionHandler {
	...
	static {
		...
		if(exclusionRegexes.length == 0) {
			throw new RuntimeException("no exclusionregexes defined in application.conf.");
		}
